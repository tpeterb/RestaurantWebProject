    ...
    <div class="container">
		...
		<section class="formSection">
			<div class="formContainer">
				<form method="post" name="contactForm" action="emailSender.php">
					...
					<div class="row">
						<div class="inputHolder">
							<textarea required rows="10" name="message" placeholder="Kérem, hogy ide írja az üzenetet!"></textarea>
						</div>
					</div>
					<div class="row">
						<div class="submitHolder">
							<input class="submitButton" type="submit" name="submit" value="Küldés">
						</div>
					</div>
				</form>
			</div>
